      ...
      <div className="container mx-auto px-4">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          <div className="col-span-1 md:col-span-2">
            <h2 className="text-2xl font-bold text-primary">Job Hunt</h2>
            <p className="text-muted-foreground mt-2">Find your dream job or the perfect candidate with our comprehensive job portal.</p>
            <p className="text-sm text-muted-foreground mt-4">© 2024 Job Hunt. All rights reserved.</p>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li><a href="/browse" className="text-muted-foreground hover:text-primary transition-colors">Browse Jobs</a></li>
          ...
          <div>
            ...
            <div className="flex space-x-4">
              ...
              <motion.a 
                ...
                aria-label="Twitter"
              >
                <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24"><path d="M24 4.557a9.835 9.835 0 01-2.828.775 4.934 4.934 0 002.165-2.724 9.867 9.867 0 01-3.127 1.195 4.924 4.924 0 00-8.38 4.49A13.978 13.978 0 011.67 3.149 4.93 4.93 0 003.16 9.724a4.903 4.903 0 01-2.229-.616v.062a4.93 4.93 0 003.946 4.827 4.902 4.902 0 01-2.224.084a4.93 4.93 0 004.6 3.417A9.869 9.869 0 010 21.543a13.978 13.978 0 007.548 2.212c9.057 0 14.01-7.507 14.01-14.01 0-.213-.004-.425-.015-.636A10.012 10.012 0 0024 4.557z" /></svg>
              </motion.a>
              <motion.a 
                whileHover={{ y: -3 }}
